This analysis shows growth curves for vocabulary size (the number of words on the CDI form that a child produces or understands), for different languages, forms, and measures.
